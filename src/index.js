...
(function(factory) {
...
}(function(ApiClient, Constraint, CreateConstraintRequest, CreateFlagRequest, CreateSegmentRequest, CreateTagRequest, CreateVariantRequest, Distribution, Error, EvalContext, EvalDebugLog, EvalResult, EvaluationBatchRequest, EvaluationBatchResponse, EvaluationEntity, Flag, FlagSnapshot, Health, PutDistributionsRequest, PutFlagRequest, PutSegmentReorderRequest, PutSegmentRequest, PutVariantRequest, Segment, SegmentDebugLog, SetFlagEnabledRequest, Tag, Variant, ConstraintApi, DistributionApi, EvaluationApi, ExportApi, FlagApi, HealthApi, SegmentApi, TagApi, VariantApi) {
  'use strict';

  /**
   * jsflagr is a Javascript client SDK for Flagr..<br>
   * The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
   * <p>
   * An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
   * <pre>
   * var Jsflagr = require('index'); // See note below*.
   * var xxxSvc = new Jsflagr.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new Jsflagr.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new Jsflagr.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new Jsflagr.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
